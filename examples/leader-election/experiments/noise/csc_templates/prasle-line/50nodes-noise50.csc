...
<simconf version="2024090601">
  <simulation>
    <title>PRASLE Leader Election - 50 Nodes (Line Topology) - 50% Success Rate (Network Noise)</title>
    ...
    <motetype>
      ...
      <commands>$(MAKE) -j$(CPUS) prasle-node.cooja TARGET=cooja ALGORITHM=prasle TOPOLOGY=line NETWORK_SIZE=50 FAST_MODE=1</commands>
