...
<simconf version="2024090601">
  <simulation>
    <title>PRASLE Leader Election - 10 Nodes (Line Topology) - 90% Success Rate (Network Noise)</title>
    ...
    <motetype>
      ...
      <commands>$(MAKE) -j$(CPUS) prasle-node.cooja TARGET=cooja ALGORITHM=prasle TOPOLOGY=line NETWORK_SIZE=10 FAST_MODE=1</commands>
