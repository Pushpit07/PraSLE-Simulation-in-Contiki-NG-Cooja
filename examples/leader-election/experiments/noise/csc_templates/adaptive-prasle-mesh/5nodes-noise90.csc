...
<simconf version="2024090601">
  <simulation>
    <title>ADAPTIVE_PRASLE Leader Election - 5 Nodes (Mesh Topology) - 90% Success Rate (Network Noise)</title>
    ...
    <motetype>
      ...
      <commands>$(MAKE) -j$(CPUS) adaptive-prasle-node.cooja TARGET=cooja ALGORITHM=adaptive-prasle TOPOLOGY=mesh NETWORK_SIZE=5</commands>
