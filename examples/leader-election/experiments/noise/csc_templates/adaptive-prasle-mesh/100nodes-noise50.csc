...
<simconf version="2024090601">
  <simulation>
    <title>ADAPTIVE_PRASLE Leader Election - 100 Nodes (Mesh Topology) - 50% Success Rate (Network Noise)</title>
    ...
    <motetype>
      ...
      <commands>$(MAKE) -j$(CPUS) adaptive-prasle-node.cooja TARGET=cooja ALGORITHM=adaptive-prasle TOPOLOGY=mesh NETWORK_SIZE=100</commands>
