...
<simconf version="2024090601">
  <simulation>
    <title>PRASLE Leader Election - 100 Nodes (Mesh Topology) - 50% Success Rate (Network Noise)</title>
    ...
    <motetype>
      ...
      <commands>$(MAKE) -j$(CPUS) prasle-node.cooja TARGET=cooja ALGORITHM=prasle TOPOLOGY=mesh NETWORK_SIZE=100</commands>
