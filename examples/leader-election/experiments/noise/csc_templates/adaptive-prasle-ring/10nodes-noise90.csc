...
<simconf version="2024090601">
  <simulation>
    <title>ADAPTIVE_PRASLE Leader Election - 10 Nodes (Ring Topology) - 90% Success Rate (Network Noise)</title>
    <randomseed>123456</randomseed>
    <motedelay_us>1000000</motedelay_us>
    <radiomedium>
      org.contikios.cooja.radiomediums.UDGM
      <transmitting_range>65.3</transmitting_range>
      <interference_range>65.3</interference_range>
    ...
    <motetype>
      ...
      <commands>$(MAKE) -j$(CPUS) adaptive-prasle-node.cooja TARGET=cooja ALGORITHM=adaptive-prasle TOPOLOGY=ring NETWORK_SIZE=10</commands>
