...
<simconf version="2024090601">
  <simulation>
    <title>ADAPTIVE_PRASLE Leader Election - 100 Nodes (Ring Topology) - 70% Success Rate (Network Noise)</title>
    ...
    <motetype>
      ...
      <commands>$(MAKE) -j$(CPUS) adaptive-prasle-node.cooja TARGET=cooja ALGORITHM=adaptive-prasle TOPOLOGY=ring NETWORK_SIZE=100</commands>
