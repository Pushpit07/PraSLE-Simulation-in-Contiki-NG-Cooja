...
#
# Usage:
#   ./create-partition-plot.sh [-a algorithm] [input]
#
# Parameters:
...
#   ./create-partition-plot.sh -a ring
#   ./create-partition-plot.sh -a prasle ../../results/prasle/network_partition/50nodes_partition_20231201
#
...
RESULTS_DIR="$PROJECT_DIR/results/$ALGORITHM/network_partition"
...
if [ $# -eq 0 ]; then
    ...
    echo "No input provided. Auto-detecting most recent $ALGORITHM partition trial results..."
...
echo ""
echo "========================================================"
echo " Generating Network Partition Analysis Plots - $ALGORITHM_UPPER"
echo "========================================================"
