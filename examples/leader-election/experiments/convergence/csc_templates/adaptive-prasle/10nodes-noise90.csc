...
<simconf version="2024090601">
  <simulation>
    <title>ADAPTIVE_PRASLE Leader Election - 10 Nodes - 90% Success Rate (Network Noise)</title>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/examples/leader-election/algorithms/adaptive-prasle/adaptive-prasle-node.c</source>
      <commands>$(MAKE) -j$(CPUS) -C ../.. adaptive-prasle-node.cooja TARGET=cooja ALGORITHM=adaptive-prasle &amp;&amp; mkdir -p build/cooja &amp;&amp; ln -sf ../../build/cooja/adaptive-prasle-node.cooja build/cooja/</commands>
      <firmware>[CONTIKI_DIR]/examples/leader-election/algorithms/adaptive-prasle/build/cooja/adaptive-prasle-node.cooja</firmware>
