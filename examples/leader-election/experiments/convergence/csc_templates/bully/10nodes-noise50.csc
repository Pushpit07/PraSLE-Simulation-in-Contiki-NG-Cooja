...
<simconf version="2024090601">
  <simulation>
    <title>BULLY Leader Election - 10 Nodes - 50% Success Rate (Network Noise)</title>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/examples/leader-election/algorithms/bully/bully-node.c</source>
      <commands>$(MAKE) -j$(CPUS) -C ../.. bully-node.cooja TARGET=cooja ALGORITHM=bully &amp;&amp; mkdir -p build/cooja &amp;&amp; ln -sf ../../build/cooja/bully-node.cooja build/cooja/</commands>
      <firmware>[CONTIKI_DIR]/examples/leader-election/algorithms/bully/build/cooja/bully-node.cooja</firmware>
  ...
  <plugin>
    ...
    <plugin_config>
      <script>
/* BULLY Leader Election - Headless Execution Script */
