...
<simconf version="2024090601">
  <simulation>
    <title>PRASLE Leader Election - 10 Nodes - 70% Success Rate (Network Noise)</title>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/examples/leader-election/algorithms/prasle/prasle-node.c</source>
      <commands>$(MAKE) -j$(CPUS) -C ../.. prasle-node.cooja TARGET=cooja ALGORITHM=prasle &amp;&amp; mkdir -p build/cooja &amp;&amp; ln -sf ../../build/cooja/prasle-node.cooja build/cooja/</commands>
      <firmware>[CONTIKI_DIR]/examples/leader-election/algorithms/prasle/build/cooja/prasle-node.cooja</firmware>
