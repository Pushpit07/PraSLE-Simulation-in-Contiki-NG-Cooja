...
<simconf version="2024090601">
  <simulation>
    <title>RING Leader Election - 5 Nodes - Leader Crash Scenario</title>
    ...
    <motetype>
      ...
      <commands>$(MAKE) -j$(CPUS) -C ../.. ring-node.cooja TARGET=cooja ALGORITHM=ring RING_SIZE=5 &amp;&amp; mkdir -p build/cooja &amp;&amp; ln -sf ../../build/cooja/ring-node.cooja build/cooja/</commands>
