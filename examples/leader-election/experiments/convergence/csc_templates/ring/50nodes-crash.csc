...
<simconf version="2024090601">
  <simulation>
    <title>RING Leader Election - 50 Nodes - Leader Crash Scenario</title>
    <randomseed>123456</randomseed>
    <motedelay_us>1000000</motedelay_us>
    <radiomedium>
      org.contikios.cooja.radiomediums.UDGM
      <transmitting_range>28.3</transmitting_range>
      <interference_range>28.3</interference_range>
    ...
    <motetype>
      ...
      <commands>$(MAKE) -j$(CPUS) -C ../.. ring-node.cooja TARGET=cooja ALGORITHM=ring RING_SIZE=50 &amp;&amp; mkdir -p build/cooja &amp;&amp; ln -sf ../../build/cooja/ring-node.cooja build/cooja/</commands>
