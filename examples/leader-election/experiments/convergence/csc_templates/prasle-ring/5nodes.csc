...
<simconf version="2024090601">
  <simulation>
    <title>PRASLE Leader Election - 5 Nodes (Ring Topology)</title>
    ...
    <motetype>
      ...
      <commands>$(MAKE) -j$(CPUS) prasle-node.cooja TARGET=cooja ALGORITHM=prasle TOPOLOGY=ring NETWORK_SIZE=5 FAST_MODE=1</commands>
