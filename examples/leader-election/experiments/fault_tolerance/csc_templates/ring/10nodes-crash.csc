...
<simconf version="2024090601">
  <simulation>
    <title>RING Leader Election - 10 Nodes - Leader Crash Scenario</title>
    ...
    <motetype>
      ...
      <commands>$(MAKE) -j$(CPUS) ring-node.cooja TARGET=cooja ALGORITHM=ring RING_SIZE=10</commands>
  ...
  <plugin>
    ...
    <plugin_config>
      <script>
/* RING Leader Election - Leader Crash Scenario Script */
