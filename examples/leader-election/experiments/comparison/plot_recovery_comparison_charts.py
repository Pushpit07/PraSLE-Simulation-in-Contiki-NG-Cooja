...
Examples:
    ...
    if args.separate:
        ...
        create_combined_figure_3x2(results_dir, output_path, args.dpi, args.format, args.same_scale)
    else:
        output_path = Path(args.output)
        if not output_path.is_absolute():
            output_path = script_dir / output_path
        create_combined_figure(results_dir, output_path, args.dpi, args.format, args.same_scale)
