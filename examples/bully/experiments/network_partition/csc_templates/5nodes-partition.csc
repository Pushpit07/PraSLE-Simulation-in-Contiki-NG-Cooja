...
<simconf>
  <simulation>
    <title>Bully Leader Election Algorithm - 5 Nodes - Network Partition Scenario</title>
    ...
    <!-- ============================================== -->
    <!-- PARTITION A: Nodes 1-2 at y=20                 -->
    <!-- Expected leader: Node 2 (highest ID)           -->
    <!-- ============================================== -->
    ...
    <!-- ============================================== -->
    <!-- PARTITION B: Nodes 3-5 at y=200                -->
    <!-- Expected leader: Node 5 (highest ID)           -->
...
java.lang.System.out.println("Scenario: Network Partition (5 nodes: 2+3 split)");
